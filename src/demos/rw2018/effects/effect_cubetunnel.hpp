...
public:
    effect_cubetunnel(demo_app* _app)
    {
        app = _app;
    }
    ...
    virtual int init()
    {
        ...
        std::string imagePath = app->getResourcePath() + "texture_brick.png";
        textLoaded = textLoaded & app->png_loader.load(iChannel0, imagePath);
	...
	{
        float animation_time = (app->additive_progress-app->first_frame_tick)/1000.0;
